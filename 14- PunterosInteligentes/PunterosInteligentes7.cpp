...
class ClaseA {
    ...
    public:
    shared_ptr<ClaseB> b;  //puntero compartido a la clase B, que es un puntero inteligente que permite compartir la propiedad de un objeto entre varios punteros inteligentes
